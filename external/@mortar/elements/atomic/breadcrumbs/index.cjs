...
// src/atomic/breadcrumbs/index.ts
var breadcrumbs_exports = {};
__export(breadcrumbs_exports, {
  MteBreadcrumbItem: () => MteBreadcrumbItem,
  MteBreadcrumbOverflow: () => MteBreadcrumbOverflow,
  MteBreadcrumbs: () => MteBreadcrumbs
});
...
var parseSelectors = (styles25, selectors) => {
  if (!selectors) {
    return styles25;
  } else {
    return `${styles25}${selectors.reduce((acc, { selector, selectorWrapper, style }) => {
      if (style === "") {
        return acc;
      }
...
var constructInstanceStyles = (instanceStylesMap) => {
  ...
  [...instanceStylesMap.entries()].filter(([key, _]) => key !== "se" && key !== "sp").sort((a, b) => b[0] - a[0]).forEach(([_, selectors]) => {
    styles25 = parseSelectors(styles25, selectors);
  });
  styles25 = `${styles25}${parseSelectors("", instanceStylesMap.get("se"))}${parseSelectors(
    "",
...
var styles8 = import_lit14.css`:host{display:block}ol{align-items:center;display:flex;margin:0;padding:0}`;
...
var MteBreadcrumbs = class extends MteElement {
  ...
  render() {
    return import_lit17.html`${this.instanceStyles}<nav><ol><slot @slotchange="${this.handleSlotChange}"></slot></ol></nav>`;
  }
};
MteBreadcrumbs.styles = [styles7, styles8];
__decorateClass([
  (0, import_decorators20.queryAssignedElements)()
...
var MteText = class extends MteContentBase {
  updateInstanceStyles(changedProps) {
    ...
    if (shouldUpdateStyles) {
      ...
      this.setInstanceStyle("text", (0, import_styles9.selectorFactory)(":host:host:host:host:host"), {
  ...
  render() {
    return import_lit20.html`${this.instanceStyles}<slot></slot>`;
  }
};
MteText.styles = [styles7, styles11];
...
MteMark.styles = [
  styles7,
  css7` :host { display: inline-block; margin-right: -2px; margin-left: -2px; padding-right: 2px; padding-left: 2px; } /** Status PG Variants */ ${(0, import_styles10.forEachPGVariant)(
    "status",
    (g, p) => css7` :host([color='${p}']) { background: ${(0, import_styles10.color)({ g, p, c: "light", o: "sm" })}; color: inherit; } `
  )} `
];
...
MteIconRegistryService.registerIcons([import_icons2.mtrIconChevronRight]);
var MteBreadcrumbItem = class extends RadiusMixin(
  ...
  render() {
    const anchor = this.renderButtonTemplate(
      import_lit22.html`<slot name="prefix" part="prefix"></slot><slot></slot>`
    );
    return import_lit22.html`<span class="link-container">${anchor}</span><mte-icon class="separator" part="separator" size="16" aria-hidden="true" name="chevron-right"></mte-icon>`;
  }
};
MteBreadcrumbItem.styles = [...MteText.styles, styles3, styles10];
__decorateClass([
  (0, import_decorators22.property)({ reflect: true, attribute: "aria-current" })
...
var styles13 = import_lit24.css`:host{box-sizing:border-box;display:contents}slot[name=overlay]::slotted(*){position:absolute}`;
...
__decorateClass([
  (0, import_decorators23.queryAssignedElements)({ slot: "trigger" })
], MteOverlayTrigger.prototype, "triggerElements", 2);
__decorateClass([
  (0, import_decorators23.queryAssignedElements)({ slot: "overlay" })
...
var MteButton = class extends InverseMixin(
  ...
  render() {
    ...
    return this.renderButtonTemplate(import_lit30.html`${this.icon && !this.iconHidden || this.loading ? import_lit30.html`<span class="prefix"><span part="prefix">${this.loading ? import_lit30.html`<mte-spinner diameter="${loadingDiameter}"></mte-spinner>` : import_lit30.html`<mte-icon size="${iconSize}" name="${this.icon}" library="${(0, import_if_defined3.ifDefined)(this.iconLibrary)}"></mte-icon>`}</span></span>` : null}<slot part="label" class="label"></slot>${this.rightIcon && !this.rightIconHidden ? import_lit30.html`<span class="suffix"><span part="suffix"><mte-icon size="${iconSize}" name="${this.rightIcon}" library="${(0, import_if_defined3.ifDefined)(this.rightIconLibrary)}"></mte-icon></span></span>` : null}`);
  }
};
MteButton.styles = [styles7, styles, styles3, styles15];
// List of props for optimal style update checking
...
var styles17 = import_lit31.css`:host{--padding-y:var(--mte-space-sm);--padding-x:var(--padding-y);--border-radius:var(--group-radius,var(--mte-border-radius-full));--focus-radius:var(--group-focus-radius,var(--mte-border-radius-full));--icon-size:16px;--color:inherit}:host([radius=sm]){--border-radius:var(--mte-border-radius-sm);--focus-radius:var(--mte-border-radius-md)}:host mte-icon{height:var(--icon-size);min-height:var(--icon-size);min-width:var(--icon-size);width:var(--icon-size)}:host([size=sm]) mte-icon{--icon-size:12px}:host([size=lg]) mte-icon{--icon-size:20px}`;
...
var MteTooltip = class extends DisabledMixin(StylePartsMixin(MteElement)) {
  constructor() {
    super();
    this.id = `mte-tooltip--${nextUniqueId3++}`;
    this.position = "top";
  ...
  render() {
    return import_lit33.html`${this.instanceStyles}<div part="tooltip" class="tooltip"><slot></slot><div part="arrow" class="arrow"></div></div>`;
  }
};
MteTooltip.styles = [styles7, styles18];
__decorateClass([
...
__decorateClass([
  (0, import_decorators27.property)({ attribute: "aria-hidden", reflect: true })
], MteTooltip.prototype, "ariaHidden", 2);
__decorateClass([
  (0, import_decorators27.property)({ attribute: "aria-live", reflect: true })
...
__decorateClass([
  (0, import_decorators27.property)({ type: Number })
...
__decorateClass([
  (0, import_decorators27.state)()
], MteTooltip.prototype, "opened", 2);
__decorateClass([
  (0, import_decorators27.state)()
], MteTooltip.prototype, "assumeLabel", 2);
__decorateClass([
  (0, import_decorators27.property)({ type: Object })
...
__decorateClass([
  (0, import_decorators27.query)(".arrow")
...
var MteIconButton = class extends DensityMixin(
  ...
  render() {
    ...
    return import_lit34.html`${this.renderButtonTemplate(
      this.loading ? import_lit34.html`<mte-spinner diameter="${loadingDiameter}"></mte-spinner>` : import_lit34.html`<mte-icon name="${this.icon}" library="${this.iconLibrary}" part="icon"></mte-icon>`
    )} ${this.label ? import_lit34.html`<mte-overlay-trigger id="trigger"></mte-overlay-trigger><mte-tooltip id="tooltip" position="${this.labelPosition}" asAriaLabel ?disabled="${this.disabled}" withoutA11y>${this.label}</mte-tooltip>` : null}`;
  }
};
MteIconButton.styles = [styles7, styles, styles3, styles15, styles17];
// List of props for optimal style update checking
...
__decorateClass([
  (0, import_decorators28.property)({ type: Boolean })
...
__decorateClass([
  (0, import_decorators28.property)({ reflect: true, converter: ResponsiveValueConverter })
...
__decorateClass([
  (0, import_decorators28.property)({ type: Boolean, reflect: true, converter: ResponsiveValueConverter })
], MteIconButton.prototype, "border", 2);
__decorateClass([
  (0, import_decorators28.property)({ reflect: true, converter: ResponsiveValueConverter })
], MteIconButton.prototype, "elevation", 2);
__decorateClass([
  (0, import_decorators28.query)("#tooltip")
], MteIconButton.prototype, "tooltipElement", 2);
__decorateClass([
  (0, import_decorators28.query)("#trigger")
...
var import_icons4 = require("@mortar/icons");
...
MteTitle.styles = [...MteText.styles, styles19];
__decorateClass([
  (0, import_decorators29.property)()
...
__decorateClass([
  (0, import_decorators29.property)({ attribute: "aria-level", reflect: true })
...
var styles20 = import_lit37.css`:host{--composition-padding-y:var(--mte-space-md);--composition-padding-x:var(--mte-space-md);--composition-divider:none;--action-margin:var(--mte-space-md);align-items:center;border-bottom:var(--composition-divider);direction:row;display:flex;padding:var(--composition-padding-y) var(--composition-padding-x)}:host([withBorder]){--composition-divider:solid 1px var(--mte-border-1)}.title{display:flex;flex-direction:column;justify-content:center}.content{align-items:center;direction:row;display:flex;flex-grow:1}.action{align-self:flex-start;display:block;flex-grow:0;flex-shrink:0;margin-left:var(--action-margin)}`;
...
var MteHeader = class extends StylePartsMixin(
  ...
  render() {
    return import_lit38.html`${this.instanceStyles}<slot name="title" class="title" part="title"><mte-title>${this.label}</mte-title></slot><slot class="content" part="content"></slot><slot name="action" class="action" part="action">${this.withClose ? import_lit38.html`<mte-icon-button class="close-button" icon="close" density="compact" type="${this.closeType}" aria-label="${this.closeAriaLabel}" @click="${(e) => {
      this._onClose.emit(e);
      this._doClose.emit(e);
    }}"></mte-icon-button>` : null}</slot>`;
  }
};
MteHeader.styles = [styles7, styles20];
__decorateClass([
...
var styles21 = import_lit39.css`:host{--composition-padding-y:var(--mte-space-md);--composition-padding-x:var(--mte-space-md);display:block;padding-left:var(--composition-padding-x);padding-right:var(--composition-padding-x);position:relative}:not(mte-header)+:host{padding-top:var(--composition-padding-y)}:host+:not(mte-footer){padding-bottom:var(--composition-padding-y)}`;
...
MteContent.styles = [styles7, styles21];
...
var styles22 = import_lit41.css`:host{--composition-padding-y:var(--mte-space-md);--composition-padding-x:var(--mte-space-md);--composition-divider:none;border-top:var(--composition-divider);display:block;padding:var(--composition-padding-y) var(--composition-padding-x)}:host([actions]){align-items:center;display:flex;flex-direction:row;gap:var(--mte-space-sm);justify-content:flex-end}:host([withBorder]){--composition-divider:solid 1px var(--mte-border-1)}`;
...
MteFooter.styles = [styles7, styles22];
__decorateClass([
...
var styles23 = import_lit43.css`:host{align-items:center;color:var(--mte-ink-3);display:flex;justify-content:center;padding:var(--mte-space-sm);text-align:center;width:100%}`;
...
var MteCondition = class extends StatusColorMixin(MteContentBase) {
  ...
  render() {
    ...
    return import_lit44.html`${this.instanceStyles} ${this.loading ? import_lit44.html`<mte-spinner diameter="${Number(this.size)}"></mte-spinner>` : icon ? import_lit44.html`<mte-icon name="${icon}" color="${(0, import_if_defined4.ifDefined)(this.getColor(this.color, this.muted, this.type))}" size="${this.size}"></mte-icon>` : null}`;
  }
...
MteCondition.styles = [styles7, styles23];
__decorateClass([
...
__decorateClass([
  (0, import_decorators32.property)({ type: Number, reflect: true })
...
var styles24 = import_lit45.css`:host{display:block;position:relative}`;
...
MteSection.styles = [styles7, styles24];
...
MteIconRegistryService.registerIcons([import_icons4.mtrIconClose]);
var nextUniqueId4 = 0;
...
var MtePopover = class extends DisabledMixin(StylePartsMixin(MteElement)) {
  ...
  render() {
    ...
    return import_lit47.html`${this.instanceStyles}<div class="popover-container ${containerClasses}"><div class="popover"><div class="content" part="content"><div id="header" part="header" class="${(0, import_class_map3.classMap)({ "has-content": this.hasHeader })}"><slot name="header"></slot></div><span id="body" part="body"><slot></slot></span><div id="footer" part="footer" class="${(0, import_class_map3.classMap)({ "has-content": this.hasFooter })}"><slot name="footer"></slot></div></div></div><div part="arrow" class="arrow ${arrowClasses}"></div></div>`;
  }
};
MtePopover.styles = [styles7, styles14];
MtePopover.shadowRootOptions = { ...MteElement.shadowRootOptions, delegatesFocus: false };
__decorateClass([
  (0, import_decorators33.property)({ reflect: true })
...
__decorateClass([
  (0, import_decorators33.property)({ type: Number, reflect: true })
...
__decorateClass([
  (0, import_decorators33.property)({ attribute: "aria-hidden", reflect: true })
], MtePopover.prototype, "ariaHidden", 2);
__decorateClass([
  (0, import_decorators33.property)({ attribute: "aria-live", reflect: true })
], MtePopover.prototype, "ariaLive", 2);
__decorateClass([
  (0, import_decorators33.property)({ attribute: "aria-labelledby", reflect: true })
], MtePopover.prototype, "ariaLabelledBy", 2);
__decorateClass([
  (0, import_decorators33.property)({ attribute: "aria-describedby", reflect: true })
], MtePopover.prototype, "ariaDescribedBy", 2);
__decorateClass([
  (0, import_decorators33.property)({ reflect: true })
], MtePopover.prototype, "role", 2);
__decorateClass([
  (0, import_decorators33.property)({ attribute: "data-focus-fallback", type: Boolean, reflect: true })
...
__decorateClass([
  (0, import_decorators33.property)({ type: Number })
], MtePopover.prototype, "animationDuration", 2);
__decorateClass([
  (0, import_decorators33.property)()
], MtePopover.prototype, "portalAdapter", 2);
__decorateClass([
  (0, import_decorators33.state)()
...
__decorateClass([
  (0, import_decorators33.queryAssignedElements)({ slot: "header" })
], MtePopover.prototype, "headerElements", 2);
__decorateClass([
  (0, import_decorators33.queryAssignedElements)()
], MtePopover.prototype, "contentElements", 2);
__decorateClass([
  (0, import_decorators33.query)(".popover-container")
], MtePopover.prototype, "popoverContainerElem", 2);
__decorateClass([
  (0, import_decorators33.query)(".arrow")
...
// src/atomic/breadcrumbs/breadcrumb-overflow.element.ts
var import_icons5 = require("@mortar/icons");
MteIconRegistryService.registerIcons([import_icons5.mtrIconDotsHorizontal]);
 ...
 */
//# sourceMappingURL=data:application/json;base64,
