...
MteSmile.styles = [
  styles7,
  css7` :host { --smile-path: ellipse(125% 100% at 50% 0); display: block; clip-path: var(--smile-path); } :host([size='none']) { --smile-path: none; } :host([size='sm']) { --smile-path: ellipse(150% 100% at 50% 0); } :host([size='md']) { --smile-path: ellipse(125% 100% at 50% 0); } :host([size='lg']) { --smile-path: ellipse(100% 100% at 50% 0); } `
];
__decorateClass([
