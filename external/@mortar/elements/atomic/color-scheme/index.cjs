...
__export(color_scheme_exports, {
  MteColorSchemeMenuItem: () => MteColorSchemeMenuItem,
  MteColorSchemeNavButton: () => MteColorSchemeNavButton,
  MteColorSchemeNavItem: () => MteColorSchemeNavItem
});
...
var CustomStateSet = class extends Set {
  ...
  add(state13) {
    if (!/^--/.test(state13) || typeof state13 !== "string") {
      throw new DOMException(
        `Failed to execute 'add' on 'CustomStateSet': The specified value ${state13} must start with '--'.`
      );
    }
    const result = super.add(state13);
    const ref = customStateMap.get(this);
    const stateName = `state${state13}`;
    if (ref.isConnected) {
  ...
  delete(state13) {
    const result = super.delete(state13);
    const ref = customStateMap.get(this);
    if (ref.isConnected) {
      ref.toggleAttribute(`state${state13}`, false);
      if (ref.part) {
        ref.part.remove(`state${state13}`);
      }
    } else {
      setTimeout(() => {
        ref.toggleAttribute(`state${state13}`, false);
...
var styles11 = import_lit18.css`:host{box-sizing:border-box;display:contents}slot[name=overlay]::slotted(*){position:absolute}`;
...
var MteOverlayTrigger = class extends MteElement {
  ...
  render() {
    return import_lit19.html`<slot name="overlay"></slot><slot name="trigger"></slot>`;
  }
};
MteOverlayTrigger.styles = [styles11];
__decorateClass([
...
var MteTooltip = class extends DisabledMixin(StylePartsMixin(MteElement)) {
  ...
  render() {
    return import_lit21.html`${this.instanceStyles}<div part="tooltip" class="tooltip"><slot></slot><div part="arrow" class="arrow"></div></div>`;
  }
};
MteTooltip.styles = [styles8, styles12];
__decorateClass([
...
__decorateClass([
  (0, import_decorators21.property)({ attribute: "aria-live", reflect: true })
...
__decorateClass([
  (0, import_decorators21.property)({ type: Number })
...
__decorateClass([
  (0, import_decorators21.property)({ type: Object })
...
__decorateClass([
  (0, import_decorators21.query)(".tooltip")
], MteTooltip.prototype, "tooltipElem", 2);
__decorateClass([
  (0, import_decorators21.query)(".arrow")
...
var styles13 = import_lit22.css`:host{position:absolute}`;
...
var styles14 = import_lit23.css`:host{--z-index:var(--mte-z-index-20);--color:var(--mte-ink-1);--background:var(--mte-surface-2);--border-color:var(--mte-border-2);--radius:var(--mte-border-radius-md);--padding-y:var(--mte-space-xs);--padding-x:var(--mte-space-xs);--header-padding-y:calc(var(--padding-y) + var(--mte-space-xs) + var(--mte-space-xxs));--header-padding-x:calc(var(--padding-x) + var(--mte-space-sm) + var(--mte-space-xs));--gap:var(--mte-space-xs);--box-shadow:var(--mte-elevation-z1);pointer-events:auto}:host{display:block;pointer-events:none;position:absolute;z-index:1000}.menu{background:var(--background);border:1px solid var(--border-color);border-radius:var(--radius);box-shadow:var(--box-shadow);color:var(--color);display:none;flex-direction:column;gap:var(--gap);outline:none;overflow:hidden;overflow-y:auto;padding:var(--padding-y) var(--padding-x);pointer-events:auto;position:fixed;z-index:var(--z-index)}.header{border-bottom:2px solid var(--mte-border-1);display:none;margin:calc(var(--padding-y)*-1) calc(var(--padding-x)*-1) 0 calc(var(--padding-x)*-1);padding:var(--header-padding-y) var(--header-padding-x)}.header.has-content{display:initial}::slotted(mte-divider),mte-divider{margin:0 calc(var(--padding-x)*-1);width:calc(100% + var(--padding-x) + var(--padding-x))}`;
...
var MteDivider = class extends MteContentBase {
  ...
  render() {
    return import_lit25.html`${this.instanceStyles}${this.label}`;
  }
};
MteDivider.styles = [styles8, styles15];
__decorateClass([
...
__decorateClass([
  (0, import_decorators22.property)({ reflect: true, attribute: "aria-orientation" })
...
var MteMenu = class extends DisabledMixin(StylePartsMixin(MteElement)) {
  constructor() {
    super();
    this.id = `mte-menu--${nextUniqueId4++}`;
    ...
    this.updatePosition = () => {
      if (this.targetElement) {
        ...
        (0, import_dom2.computePosition)(this.targetElement, this.menuElem, {
          strategy: "fixed",
          placement,
          middleware: [
            (0, import_dom2.shift)({ padding: this.offset }),
  ...
  updateInstanceStyles(changedProps) {
    ...
    if (changedProps.has("maxh") || changedProps.has("minw")) {
      this.setInstanceStyle("menu", (0, import_styles10.selectorFactory)(":host:host:host:host:host:host .menu"), {
        maxh: this.maxh,
        minw: this.minw
      });
    }
  ...
  render() {
    return import_lit26.html`${this.instanceStyles}<div part="menu" class="menu"><span class="header ${(0, import_class_map3.classMap)({
      "has-content": this.hasHeader
    })}" part="header"><slot name="header" @slotchange="${this.handleHeaderSlotChange}"></slot></span><slot></slot></div>`;
  }
};
MteMenu.styles = [styles8, styles14];
__decorateClass([
...
__decorateClass([
  (0, import_decorators23.property)({ attribute: "aria-labelledby", reflect: true })
...
__decorateClass([
  (0, import_decorators23.query)(".menu")
], MteMenu.prototype, "menuElem", 2);
__decorateClass([
  (0, import_decorators23.queryAssignedElements)({ slot: "header" })
], MteMenu.prototype, "headerElems", 2);
__decorateClass([
  (0, import_decorators23.queryAssignedElements)({
...
var MteMenuItem = class extends SlotObserverMixin(
  ...
  render() {
    ...
    return this.renderButtonTemplate(import_lit28.html`${this.instanceStyles}<div class="prefix ${(0, import_class_map4.classMap)({
      "has-content": hasPrefix
    })}" part="prefix"><slot name="prefix">${this.icon ? import_lit28.html`<mte-icon class="prop-icon" muted autosize name="${this.icon}"></mte-icon>` : null}</slot></div><div class="label" part="label"><slot></slot></div><div class="suffix ${(0, import_class_map4.classMap)({
      "has-content": hasSuffix
    })}" part="suffix"><slot name="suffix">${this.suffixIcon ? import_lit28.html`<mte-icon class="prop-icon" muted autosize name="${this.suffixIcon}"></mte-icon>` : null}</slot></div><span class="nested-menu ${(0, import_class_map4.classMap)({ "has-child": hasChildren })}"><mte-icon muted autosize name="${submenuIcon}"></mte-icon><span class="nested-menu-trigger"><mte-overlay-trigger id="overlay-trigger"></mte-overlay-trigger><slot name="child"></slot></span></span>`);
  }
};
MteMenuItem.styles = [styles8, styles4, styles16];
__decorateClass([
...
__decorateClass([
  (0, import_decorators24.query)("#overlay-trigger")
], MteMenuItem.prototype, "overlayTriggerElem", 2);
__decorateClass([
  (0, import_decorators24.queryAssignedElements)({ slot: "child" })
...
var MteColorSchemeMenu = class extends MteElement {
  ...
  render() {
    ...
    return import_lit29.html`${this.instanceStyles} <span id="trigger"></span><mte-overlay-trigger id="menu-trigger"></mte-overlay-trigger><mte-menu id="menu" @onSelect="${this.handleSelection}" minw="175" triggerOn="none" position="${this.position}"><mte-menu-item role="menuitemcheckbox" aria-label='Set the color scheme to "Light"' aria-checked="${lightAriaChecked}" icon="weather-sunny" value="light" suffixIcon="${(0, import_if_defined3.ifDefined)(lightActive)}">Light</mte-menu-item><mte-menu-item role="menuitemcheckbox" aria-label='Set the color scheme to "Dark"' aria-checked="${darkAriaChecked}" icon="weather-night" value="dark" suffixIcon="${(0, import_if_defined3.ifDefined)(darkActive)}">Dark</mte-menu-item><mte-divider></mte-divider><mte-menu-item role="menuitemcheckbox" aria-label='Set the color scheme to "System"' aria-checked="${systemAriaChecked}" icon="theme-light-dark" value="system" suffixIcon="${(0, import_if_defined3.ifDefined)(systemActive)}">System</mte-menu-item></mte-menu>`;
  }
};
MteColorSchemeMenu.styles = [styles8, styles13];
__decorateClass([
...
__decorateClass([
  (0, import_decorators25.query)("#menu")
], MteColorSchemeMenu.prototype, "menuElement", 2);
__decorateClass([
  (0, import_decorators25.query)("#menu-trigger")
...
__decorateClass([
  (0, import_decorators26.query)(".button")
...
__decorateClass([
  (0, import_decorators26.query)("#tooltip-trigger")
], MteColorSchemeNavButton.prototype, "tooltipTriggerElement", 2);
__decorateClass([
  (0, import_decorators26.query)("#menu")
...
__decorateClass([
  (0, import_decorators26.eventOptions)({ capture: true })
...
var MteColorSchemeNavItem = class extends StylePartsMixin(MteElement) {
  ...
  render() {
    const activeIcon = this.colorScheme === "light" ? "weather-sunny" : this.colorScheme === "dark" ? "weather-night" : "theme-light-dark";
    return import_lit32.html`${this.instanceStyles}<div class="container"><button class="button primary" part="button" ?disabled="${this.disabled}" @click="${(e) => {
...
MteColorSchemeNavItem.styles = [styles8, styles17];
...
__decorateClass([
  (0, import_decorators27.query)(".button.primary")
], MteColorSchemeNavItem.prototype, "buttonElement", 2);
__decorateClass([
  (0, import_decorators27.query)("#menu")
...
MteIconRegistryService.registerIcons([import_icons3.mtrIconChevronRight]);
var MteColorSchemeMenuItem = class extends ButtonMixin(
  ...
  render() {
    const activeIcon = this.colorScheme === "light" ? "weather-sunny" : this.colorScheme === "dark" ? "weather-night" : "theme-light-dark";
    const submenuIcon = this.withAltSubmenuIndicator ? "dots-horizontal" : "menu-right";
    return this.renderButtonTemplate(import_lit33.html`${this.instanceStyles}<div class="prefix has-content"><mte-icon class="prop-icon" muted autosize name="${activeIcon}"></mte-icon></div><div class="label" part="label">${this.label}</div><div class="suffix"></div><span class="nested-menu has-child"><mte-icon muted autosize name="${submenuIcon}"></mte-icon></span><mte-color-scheme-menu id="menu" position="right"></mte-color-scheme-menu>`);
  }
};
MteColorSchemeMenuItem.styles = [styles8, styles4, styles16];
__decorateClass([
...
__decorateClass([
  (0, import_decorators28.query)("#menu")
...
MteIconRegistryService.registerIcons([
  import_icons4.mtrIconWeatherSunny,
  import_icons4.mtrIconWeatherNight,
  import_icons4.mtrIconThemeLightDark
]);
/**
 * @license
 ...
 */
//# sourceMappingURL=data:application/json;base64,
