...
// src/atomic/tree/index.ts
var tree_exports = {};
__export(tree_exports, {
  AllTreeElements: () => AllTreeElements,
  MteTree: () => MteTree,
  MteTreeItem: () => MteTreeItem,
...
var generateSelectorsFromStyleMap = (selectorFn, styleMap3) => {
  const parsedSelectors = [];
  const selectorQueue = [{ selector: selectorFn(), styleMap: styleMap3 }];
...
var MteElement = class extends import_lit.LitElement {
   ...
   */
  setInstanceStyle(id, selector, styleMap3) {
    this.__instanceStyleSheetMap.set(id, generateSelectorsFromStyleMap(selector, styleMap3));
  ...
  class StylePartsElement extends superClass {
    updateInstanceStyles(changedProps) {
      ...
      if (changedProps.has("sp")) {
        Object.entries(this.sp ?? {}).forEach(([part, styleMap3]) => {
          ...
          this.setInstanceStyle(`sp-${part}`, selector, styleMap3);
        });
      }
    }
  }
...
var CustomStateSet = class extends Set {
  ...
  add(state11) {
    if (!/^--/.test(state11) || typeof state11 !== "string") {
      throw new DOMException(
        `Failed to execute 'add' on 'CustomStateSet': The specified value ${state11} must start with '--'.`
      );
    }
    const result = super.add(state11);
    const ref = customStateMap.get(this);
    const stateName = `state${state11}`;
    if (ref.isConnected) {
  ...
  delete(state11) {
    const result = super.delete(state11);
    const ref = customStateMap.get(this);
    if (ref.isConnected) {
      ref.toggleAttribute(`state${state11}`, false);
      if (ref.part) {
        ref.part.remove(`state${state11}`);
      }
    } else {
      setTimeout(() => {
        ref.toggleAttribute(`state${state11}`, false);
...
var styles8 = import_lit14.css`:host{background:rgb(var(--mte-surface-2-rgb));border-radius:var(--mte-border-radius-md);display:block;padding:6px;position:relative}::slotted(mte-tree-item){margin-left:0}`;

// src/atomic/tree/tree.context.ts
var import_context3 = require("@lit-labs/context");
var treeContext = (0, import_context3.createContext)("MTE_TREE_CONTEXT");
...
var MteTree = class extends DensityMixin(PresetMixinFactory("MteTree")(MteElement)) {
  constructor() {
    ...
    this.withLine = false;
    if (!isSsr()) {
      this.treeContextProvider = new import_context4.ContextProvider(this, treeContext, {
...
MteTree.styles = [styles7, styles, styles8];
__decorateClass([
  presetProperty()
...
var import_style_map2 = require("lit/directives/style-map.js");
...
var styles10 = import_lit18.css`:host{display:grid;grid-template-rows:0fr;will-change:grid-template-rows,opacity}.content{overflow:hidden}`;
...
var MteCollapse = class extends DisabledMixin(
  ...
  constructor() {
    super();
    this.id = `mte-collapse--${nextUniqueId2++}`;
    this.opened = false;
    this.withFade = false;
  ...
  handleOpenedChanged() {
    if (isSsr() || !this.firstUpdateComplete) {
      ...
      if (!this.withoutAnimation) {
        ...
        const ease = import_styles9.config.animation.timingFunctionJs.standard;
  ...
  updateInstanceStyles(changedProps) {
    ...
    if (changedProps.has("opacity") || changedProps.has("visibility") || changedProps.has("overflow") || changedProps.has("initialGridTemplateRows")) {
      this.setInstanceStyle("collapse", (0, import_styles9.selectorFactory)(this.instanceStyleSelectorRoot), {
        opacity: this.opacity,
  ...
  render() {
    return import_lit19.html`${this.instanceStyles}<div class="content" part="content"><slot></slot></div>`;
  }
  toggle() {
    if (this.opened) {
      this.close();
...
MteCollapse.styles = [styles7, styles10];
__decorateClass([
...
__decorateClass([
  (0, import_decorators20.property)({ type: Number })
...
__decorateClass([
  (0, import_decorators20.property)({ type: Object })
...
__decorateClass([
  (0, import_decorators20.query)(".content")
...
var defaultButtonBorderFactory = (width, color, style) => `${style ?? "solid"} ${borderWidthValShorthands([
  { prop: "borderWidth", value: dotStringToConfigValue(width ?? "1px") }
])[0]?.value} ${dotStringToConfigValue(color) ?? import_styles10.config.color.border1}`;
...
var MteButton = class extends InverseMixin(
  ...
  updateInstanceStyles(changedProps) {
    ...
    if (shouldUpdateStyles) {
      this.setInstanceStyle("content-base", (0, import_styles11.selectorFactory)(":host:host:host:host:host:host"), {
        // Spacing
        m: this.m,
        mx: this.mx,
        my: this.my,
...
var styles13 = import_lit24.css`:host{--padding-y:var(--mte-space-sm);--padding-x:var(--padding-y);--border-radius:var(--group-radius,var(--mte-border-radius-full));--focus-radius:var(--group-focus-radius,var(--mte-border-radius-full));--icon-size:16px;--color:inherit}:host([radius=sm]){--border-radius:var(--mte-border-radius-sm);--focus-radius:var(--mte-border-radius-md)}:host mte-icon{height:var(--icon-size);min-height:var(--icon-size);min-width:var(--icon-size);width:var(--icon-size)}:host([size=sm]) mte-icon{--icon-size:12px}:host([size=lg]) mte-icon{--icon-size:20px}`;
...
var MteTooltip = class extends DisabledMixin(StylePartsMixin(MteElement)) {
  constructor() {
    ...
    this.animationDuration = import_styles12.config.animation.transitionDurationJs.short * 1e3;
  ...
  set triggerElementRef(newElem) {
    if (this._triggerElementRef !== newElem) {
      ...
      if (this._triggerElementRef && !this._triggerElementRef?.id) {
        this._triggerElementRef.id = `mte-overlay-trigger--trigger--${nextUniqueId4++}`;
      }
...
var MteIconButton = class extends DensityMixin(
  ...
  updateInstanceStyles(changedProps) {
    ...
    if (shouldUpdateStyles) {
      this.setInstanceStyle("content-base", (0, import_styles13.selectorFactory)(":host:host:host:host:host:host"), {
        // Spacing
        m: this.m,
        mx: this.mx,
        my: this.my,
...
var MteTreeItem = class extends MteElement {
  constructor() {
    ...
    this.treeContextConsumer = new import_context5.ContextConsumer(
      this,
      treeContext,
  ...
  connectedCallback() {
    ...
    this.id = `mte-tree-item--${nextUniqueId5++}`;
  ...
  render() {
    ...
    const rowClasses = (0, import_class_map3.classMap)({
    ...
    const activeIndicatorStyles = (0, import_style_map2.styleMap)({
      left: `-${this.nestLevel * 24 + 12}px`
    });
    const leafIconSize = this.density === "compact" ? 16 : this.density === "roomy" ? 20 : 18;
    return import_lit31.html`<div class="row ${rowClasses}">${indicatorIcon ? import_lit31.html`<div class="indicator" part="indicator" @click="${this.toggleExpanded}"><mte-icon name="${indicatorIcon}" size="${indicatorIcon !== "chevron-down" && indicatorIcon !== "chevron-right" ? leafIconSize : leafIconSize + 4}"></mte-icon></div>` : null} ${this.href ? import_lit31.html`<a class="label" part="label" href="${this.href}" target="${this.target}">${this.icon ? import_lit31.html`<mte-icon class="label__icon" name="${this.icon}" size="${leafIconSize}"></mte-icon>` : null}<slot name="label">${this.label}</slot></a>` : import_lit31.html`<div class="label" part="label" @click="${notLeafTrigger ? this.clicked : this.toggleExpanded}">${this.icon ? import_lit31.html`<mte-icon class="label__icon" name="${this.icon}" size="${leafIconSize}"></mte-icon>` : null}<slot name="label">${this.label}</slot></div>`}</div>${this.active ? import_lit31.html`<div class="active-indicator" style="${activeIndicatorStyles}"></div>` : null}<mte-collapse withoutAnimation ?opened="${this.expanded}" withFade showOverflow><slot class="content" part="content" role="group"></slot></mte-collapse>`;
  }
  toggleExpanded() {
...
MteTreeItem.styles = [styles7, styles16];
__decorateClass([
...
__decorateClass([
  (0, import_decorators27.queryAssignedElements)()
], MteTreeItem.prototype, "childItems", 2);
__decorateClass([
  (0, import_decorators27.queryAsync)(".indicator")
 ...
 */
//# sourceMappingURL=data:application/json;base64,
