...
var styles8 = import_lit14.css`:host{display:flex}:host([direction=columnReverse]),:host([direction=column]){align-items:stretch;flex-direction:column}:host([direction=rowReverse]),:host([direction=row]){align-items:center;flex-direction:row}:host([row]){align-items:center;flex-direction:row!important}`;
...
MteStack.styles = [styles7, styles8];
__decorateClass([
