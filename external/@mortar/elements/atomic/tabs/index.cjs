...
// src/atomic/tabs/index.ts
var tabs_exports = {};
__export(tabs_exports, {
  MteNewTabButton: () => MteNewTabButton,
  MteTab: () => MteTab,
  MteTabPanel: () => MteTabPanel,
  MteTabs: () => MteTabs
});
...
var MteTab = class extends ButtonMixin(MteElement) {
  ...
  render() {
    return this.renderButtonTemplate(
      import_lit19.html`<div class="content"><slot name="prefix"></slot><slot></slot><slot name="suffix"></slot></div><span class="indicator"></span>`
    );
  }
};
MteTab.styles = [styles7, styles3, styles10];
__decorateClass([
...
__decorateClass([
  (0, import_decorators21.property)({ reflect: true, attribute: "aria-selected" })
], MteTab.prototype, "ariaSelected", 2);
__decorateClass([
  (0, import_decorators21.property)({ reflect: true })
], MteTab.prototype, "role", 2);
__decorateClass([
  (0, import_decorators21.property)({ reflect: true, attribute: "aria-controls" })
...
var styles11 = import_lit20.css`:host{padding:16px}:host(:not([selected])){display:none}:host([selected]){display:block}`;
...
var MteTabPanel = class extends MteContentBase {
  constructor() {
    ...
    this.active = false;
    this.selected = false;
    this.id = `mte-tab-panel--${nextUniqueId3++}`;
  }
  render() {
    return import_lit21.html`${this.instanceStyles}<slot></slot>`;
  }
};
MteTabPanel.styles = [styles7, styles11];
__decorateClass([
...
__decorateClass([
  (0, import_decorators22.property)({ reflect: true, attribute: "aria-labelledby" })
...
var styles12 = import_lit22.css`:host{align-items:center;display:flex;height:100%;justify-content:center;padding:9px 16px;z-index:1}:host(:active){--background:rgba(var(--mte-it-surface-2-active-rgb),var(--mte-it-surface-2-active-a))}:host(:focus){--background:rgba(var(--mte-it-surface-2-hover-rgb),var(--mte-it-surface-2-hover-a))}`;
...
__decorateClass([
  (0, import_decorators23.property)({ attribute: "aria-valuenow", reflect: true })
], MteProgressSpinner.prototype, "ariaValueNow", 2);
__decorateClass([
  (0, import_decorators23.property)({ attribute: "aria-valuemin", reflect: true })
], MteProgressSpinner.prototype, "ariaValueMin", 2);
__decorateClass([
  (0, import_decorators23.property)({ attribute: "aria-valuemax", reflect: true })
...
var MteButton = class extends InverseMixin(
  ...
  render() {
    ...
    return this.renderButtonTemplate(import_lit26.html`${this.icon && !this.iconHidden || this.loading ? import_lit26.html`<span class="prefix"><span part="prefix">${this.loading ? import_lit26.html`<mte-spinner diameter="${loadingDiameter}"></mte-spinner>` : import_lit26.html`<mte-icon size="${iconSize}" name="${this.icon}" library="${(0, import_if_defined3.ifDefined)(this.iconLibrary)}"></mte-icon>`}</span></span>` : null}<slot part="label" class="label"></slot>${this.rightIcon && !this.rightIconHidden ? import_lit26.html`<span class="suffix"><span part="suffix"><mte-icon size="${iconSize}" name="${this.rightIcon}" library="${(0, import_if_defined3.ifDefined)(this.rightIconLibrary)}"></mte-icon></span></span>` : null}`);
  }
};
MteButton.styles = [styles7, styles, styles3, styles13];
// List of props for optimal style update checking
...
var styles15 = import_lit27.css`:host{--padding-y:var(--mte-space-sm);--padding-x:var(--padding-y);--border-radius:var(--group-radius,var(--mte-border-radius-full));--focus-radius:var(--group-focus-radius,var(--mte-border-radius-full));--icon-size:16px;--color:inherit}:host([radius=sm]){--border-radius:var(--mte-border-radius-sm);--focus-radius:var(--mte-border-radius-md)}:host mte-icon{height:var(--icon-size);min-height:var(--icon-size);min-width:var(--icon-size);width:var(--icon-size)}:host([size=sm]) mte-icon{--icon-size:12px}:host([size=lg]) mte-icon{--icon-size:20px}`;
...
var MteTooltip = class extends DisabledMixin(StylePartsMixin(MteElement)) {
  constructor() {
    super();
    this.id = `mte-tooltip--${nextUniqueId4++}`;
    this.position = "top";
  ...
  render() {
    return import_lit29.html`${this.instanceStyles}<div part="tooltip" class="tooltip"><slot></slot><div part="arrow" class="arrow"></div></div>`;
  }
};
...
__decorateClass([
  (0, import_decorators26.property)({ attribute: "aria-hidden", reflect: true })
], MteTooltip.prototype, "ariaHidden", 2);
__decorateClass([
  (0, import_decorators26.property)({ attribute: "aria-live", reflect: true })
...
__decorateClass([
  (0, import_decorators26.property)({ type: Number })
...
__decorateClass([
  (0, import_decorators26.query)(".arrow")
...
var styles17 = import_lit30.css`:host{box-sizing:border-box;display:contents}slot[name=overlay]::slotted(*){position:absolute}`;
...
var MteOverlayTrigger = class extends MteElement {
  ...
  set triggerElementRef(newElem) {
    if (this._triggerElementRef !== newElem) {
      ...
      if (this._triggerElementRef && !this._triggerElementRef?.id) {
        this._triggerElementRef.id = `mte-overlay-trigger--trigger--${nextUniqueId5++}`;
      }
  ...
  render() {
    return import_lit31.html`<slot name="overlay"></slot><slot name="trigger"></slot>`;
  }
};
MteOverlayTrigger.styles = [styles17];
__decorateClass([
...
__decorateClass([
  (0, import_decorators27.queryAssignedElements)({ slot: "trigger" })
], MteOverlayTrigger.prototype, "triggerElements", 2);
__decorateClass([
  (0, import_decorators27.queryAssignedElements)({ slot: "overlay" })
...
var MteIconButton = class extends DensityMixin(
  ...
  render() {
    ...
    return import_lit32.html`${this.renderButtonTemplate(
      this.loading ? import_lit32.html`<mte-spinner diameter="${loadingDiameter}"></mte-spinner>` : import_lit32.html`<mte-icon name="${this.icon}" library="${this.iconLibrary}" part="icon"></mte-icon>`
    )} ${this.label ? import_lit32.html`<mte-overlay-trigger id="trigger"></mte-overlay-trigger><mte-tooltip id="tooltip" position="${this.labelPosition}" asAriaLabel ?disabled="${this.disabled}" withoutA11y>${this.label}</mte-tooltip>` : null}`;
  }
};
MteIconButton.styles = [styles7, styles, styles3, styles13, styles15];
// List of props for optimal style update checking
...
var MteNewTabButton = class extends ButtonMixin(MteElement) {
  ...
  render() {
    return this.renderButtonTemplate(
      import_lit33.html`<mte-icon name="plus" size="20" aria-label="Add new tab"></mte-icon>`
    );
  }
};
MteNewTabButton.styles = [styles7, styles10, styles12];
__decorateClass([
 ...
 */
//# sourceMappingURL=data:application/json;base64,
