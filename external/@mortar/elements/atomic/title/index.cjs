...
var MteTitle = class extends MteText {
  ...
  updateInstanceStyles(changedProps) {
    ...
    if (changedProps.has("align")) {
      this.setInstanceStyle("text", (0, import_styles10.selectorFactory)(":host:host:host"), {
