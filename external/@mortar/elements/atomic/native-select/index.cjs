...
// src/atomic/native-select/index.ts
var native_select_exports = {};
__export(native_select_exports, {
  MteNativeSelect: () => MteNativeSelect,
  MteNativeSelectOptgroup: () => MteNativeSelectOptgroup,
  MteNativeSelectOption: () => MteNativeSelectOption
});
...
var styles10 = import_lit18.css`:host{font-family:var(--mte-font-family-sans);-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;align-items:center;background:rgb(var(--mte-core-danger-lighter-rgb));border-radius:var(--mte-border-radius-xs);color:rgb(var(--mte-core-danger-base-rgb));display:flex;font-size:var(--mte-font-set-caption-font-size);font-weight:var(--mte-font-set-caption-font-weight);font-weight:var(--mte-font-weight-medium);gap:var(--mte-space-xs);line-height:var(--mte-font-set-caption-line-height);margin:var(--mte-space-xs) 0;overflow:hidden;padding:0 var(--mte-space-xs);text-decoration:inherit;text-transform:inherit;width:100%}`;
...
var MteNativeSelectOptgroup = class extends DisabledMixin(MteElement) {
  ...
  render() {
    return import_lit25.html`<slot></slot>`;
  }
};
MteNativeSelectOptgroup.styles = import_lit25.css` :host { display: none; } `;
__decorateClass([
...
MteNativeSelectOption.styles = import_lit26.css` :host { display: none; } `;
__decorateClass([
...
var import_guard = require("lit/directives/guard.js");
MteIconRegistryService.registerIcons([import_icons3.mtrIconChevronDown]);
var nextUniqueId5 = 0;
var MteNativeSelect = class extends TabIndexMixin(
  ...
  constructor() {
    super(...arguments);
    this.id = `mte-select--${nextUniqueId5++}`;
    this.options = null;
    this.readonly = false;
    this.required = false;
  ...
  renderOption(option) {
    ...
    return (0, import_guard.guard)(
      [option[this.valueProp], option.disabled, isSelected, text],
      () => import_lit27.html`<option value="${(0, import_if_defined4.ifDefined)(option[this.valueProp])}" ?disabled="${option.disabled}" ?selected="${isSelected}">${text}</option>`
    );
  }
  renderOptgroup(optgroup) {
    return import_lit27.html`<optgroup ?disabled="${optgroup.disabled}" label="${(0, import_if_defined4.ifDefined)(optgroup.label)}">${optgroup instanceof MteNativeSelectOptgroup ? (0, import_repeat.repeat)(
      optgroup.children,
      (option) => option,
  ...
  render() {
    ...
    return this.renderFieldsetTemplate(
      this.renderFormFieldTemplate(
        import_lit27.html`${this.instanceStyles}<div class="select-wrapper" part="wrapper"><select part="select" class="select" id="input" ?disabled="${this.disabled || this.readonly}" ?required="${this.required}" ?autofocus="${this.autofocus}" title="${this.title}" name="${(0, import_if_defined4.ifDefined)(this.name)}" .value="${(0, import_live.live)(this.value)}" aria-describedby="${(0, import_if_defined4.ifDefined)(describedBy === "" ? void 0 : describedBy)}" aria-invalid="${showError ? "true" : "false"}" @change="${this.handleChange}" @input="${this.handleInput}" @focus="${this.handleFocus}" @blur="${this.handleBlur}">${this.renderSelectChildren()}</select><mte-icon part="icon" class="chevron" name="chevron-down"></mte-icon></div><slot></slot>`,
        {
...
MteNativeSelect.styles = [styles7, styles, styles6, styles5, styles13];
/** @ignore */
MteNativeSelect.formControlValidators = [import_form_control2.requiredValidator];
__decorateClass([
...
__decorateClass([
  (0, import_decorators26.queryAssignedElements)({
