...
// src/bespoke/partner-badge/index.ts
var partner_badge_exports = {};
__export(partner_badge_exports, {
  MtePartnerBadge: () => MtePartnerBadge
});
module.exports = __toCommonJS(partner_badge_exports);
...
var MtePartnerBadge = class extends MteElement {
  ...
  render() {
    return import_lit17.html`${this.instanceStyles}<div class="container with-shadow"><div class="header"><div class="logo"></div><div class="year">${!this.year || this.year < 1 ? import_lit17.html`<mte-icon name="star" size="28"></mte-icon>` : this.year}</div></div><div class="content">${this.name}</div><div class="footer"><div class="texas"><mte-icon name="texas" size="24"></mte-icon></div><div class="text">Because People Matter</div></div></div>`;
  }
};
MtePartnerBadge.styles = [styles8, styles];
__decorateClass([
